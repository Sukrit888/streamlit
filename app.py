...
def load_data(file_path):
    """Loads data from a local CSV file and caches it."""
    try:
        ...
        st.warning("Please make sure the CSV file is in the same GitHub repository as the app.py file.")
        return None
